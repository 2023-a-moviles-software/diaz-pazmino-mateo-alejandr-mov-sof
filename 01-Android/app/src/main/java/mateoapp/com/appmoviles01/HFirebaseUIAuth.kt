...
class HFirebaseUIAuth : AppCompatActivity() {
    ...
    fun registrarUsuariosPorPrimeraVez(usuario: IdpResponse){/* usuario.email; usuario.phoneNumber; usuario.user.name;*/ }
