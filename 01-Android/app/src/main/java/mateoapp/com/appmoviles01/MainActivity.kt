...
class MainActivity : AppCompatActivity() {
    val callbackContenidoIntentExplicito = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){
        result ->
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        EBaseDeDatos.tablaEntrenador = ESquliteHelperEntrenador(this)
    ...
    fun abrirActividadConParametros(clase: Class<*>){
        ...
        //Enviar parametros
        //(aceptamos primiitivas)
        intentExplicito.putExtra("nombre","Adrian")
        intentExplicito.putExtra("apellido","Eguez")
        intentExplicito.putExtra("edad",30)
        intentExplicito.putExtra("entrenador",BEntrenador(1,"Adrian",
            "Entrenador"))
